...
### Fixed
- Fixed critical bug in `getCardDetails()` where all board labels were returned instead of only labels assigned to the specific card
- Now correctly filters labels based on the `cardLabels` relationship from the Planka API
